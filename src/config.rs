...
pub const LINK_DOCS_HOME: &str = "https://rustdesk.com/docs/zh/";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["62.234.178.80"];
pub const RS_PUB_KEY: &str = "tDTwK2WhXwpB1lScaRtJj8p75z22o09AvtNoMtg9ZhU=";
